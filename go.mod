...
require (
	github.com/cisco-app-networking/nsm-nse v0.2.5-vl3
	github.com/davecgh/go-spew v1.1.1
	github.com/golang/protobuf v1.4.2
	github.com/grpc-ecosystem/go-grpc-prometheus v1.2.0
	github.com/grpc-ecosystem/grpc-opentracing v0.0.0-20180507213350-8e809c8a8645
	github.com/cisco-app-networking/networkservicemesh/controlplane/api v0.2.3-vl3
	github.com/cisco-app-networking/networkservicemesh/forwarder/api v0.2.3-vl3
	github.com/cisco-app-networking/networkservicemesh/k8s v0.2.3-vl3
